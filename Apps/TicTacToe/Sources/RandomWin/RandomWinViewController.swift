...
final class RandomWinViewController: UIViewController, RandomWinPresentable,
    RandomWinViewControllable
{
    ...
    func announce(winner: PlayerType, withCompletionHandler handler: @escaping () -> Void) {
        ...
        let closeAction = UIAlertAction(
            title: "That was random...", style: UIAlertAction.Style.default
        ) { _ in
            handler()
        }
