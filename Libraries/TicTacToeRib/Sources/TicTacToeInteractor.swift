...
/// @mockable
public protocol TicTacToePresentable: Presentable {
...
public final class TicTacToeInteractor: PresentableInteractor<TicTacToePresentable>,
    TicTacToeInteractable, TicTacToePresentableListener
{
    ...
    public func placeCurrentPlayerMark(atRow row: Int, col: Int) {
